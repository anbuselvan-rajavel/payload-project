...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_projects_projects" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_projects_projects" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"project_title" varchar,
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_projects_projects" ADD CONSTRAINT "pages_blocks_projects_projects_project_image_id_media_id_fk" FOREIGN KEY ("project_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_projects_projects" ADD CONSTRAINT "_pages_v_blocks_projects_projects_project_image_id_media_id_fk" FOREIGN KEY ("project_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_projects_projects_order_idx" ON "pages_blocks_projects_projects" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_projects_projects_parent_id_idx" ON "pages_blocks_projects_projects" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_projects_projects_project_image_idx" ON "pages_blocks_projects_projects" USING btree ("project_image_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_projects_projects_order_idx" ON "_pages_v_blocks_projects_projects" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_projects_projects_parent_id_idx" ON "_pages_v_blocks_projects_projects" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_projects_projects_project_image_idx" ON "_pages_v_blocks_projects_projects" USING btree ("project_image_id");
